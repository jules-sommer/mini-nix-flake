...
let
  ...
  inherit (lib.xeta) mkOpt getPackage getThemeBase24;
  cfg = config.xeta.desktop.hyprland;

  base_theme = getThemeBase24 cfg.theme;
  theme = base_theme.colors;
  shell = lib.getBin pkgs.nushell;
  home = "/home/jules";
  screenshot = ''
    ${shell} ${home}/000_dev/030_nushell/screenshot.nu
  '';
in
# get_time = ''
...
# ''; 
{
  ...
  config = mkIf cfg.enable {
    assertions = [
      {
        assertion = home == "/home/jules";
        message = "invalid $home path, should be '/home/jules' instead got '${home}'";
      }
    ];
    ...
    wayland.windowManager.hyprland =
      ...
      in
      {
        ...
        settings = {
          ...
          plugins = [
            # hyprland-vdesk.packages.${pkgs.system}.virtual-desktops
            # (getPackage {
            #   inherit system;
            #   input = inputs.hycov;
            #   name = "hycov";
